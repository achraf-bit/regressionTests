...
CustomKeywords.'modules.Transport.openTrFromDashboard'('ESC-A16693')
...
WebUI.waitForElementNotPresent(findTestObject('TMS Commons/Form/Documents/Documents Loader'), 20)

WebUI.verifyElementNotPresent(findTestObject('TMS Commons/Form/Documents/TypeOfDoc - EX'), 0)
