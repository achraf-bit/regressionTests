...
public class MultimodalSchemes {
	@Keyword
	def addNewMultimodalSchemes() {
		...
		WebUI.click(findTestObject('Object Repository/Settings/Multimodal Schemes Settings/button_Multimodal schemes'))
		...
		WebUI.waitForElementVisible(findTestObject('Object Repository/Settings/Multimodal Schemes Settings/input_Code'), 0)
		WebUI.setText(findTestObject('Object Repository/Settings/Multimodal Schemes Settings/input_Code'), 'test')
		WebUI.setText(findTestObject('Object Repository/Settings/Multimodal Schemes Settings/input_label'), 'test')
		WebUI.click(findTestObject('Object Repository/Settings/Multimodal Schemes Settings/button_Pre-carriage'))
		WebUI.delay(3)
	...
	def editMultimodalSchemes() {
		...
		WebUI.waitForElementVisible(findTestObject('Object Repository/Settings/Multimodal Schemes Settings/input_Code'), 0)
		WebUI.delay(3)
		WebUI.setText(findTestObject('Object Repository/Settings/Multimodal Schemes Settings/input_Code'), 'test2')
		WebUI.setText(findTestObject('Object Repository/Settings/Multimodal Schemes Settings/input_label'), 'test2')
		WebUI.click(findTestObject('Object Repository/Settings/Modal/button_Save'))
		WebUI.waitForElementVisible(findTestObject('Object Repository/Growl Notification/flash_Notice_Operation successfully completed'), 0 ,FailureHandling.CONTINUE_ON_FAILURE)
		WebUI.verifyElementVisible(findTestObject('Object Repository/Growl Notification/flash_Notice_Operation successfully completed'),FailureHandling.CONTINUE_ON_FAILURE)
		WebUI.waitForElementVisible(findTestObject('Object Repository/Settings/Dashboard/first input in dashboard'),0)
