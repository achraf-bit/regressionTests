...
public class CostsItems {
	...
	def addCostItem() {
		...
		WebUI.click(findTestObject('Object Repository/Settings/Costs Items Settings/button_Costs items'))
		WebUI.waitForElementVisible(findTestObject('Object Repository/Settings/Costs Items Settings/input_Code Dashboard'),0)
		WebUI.click(findTestObject('Object Repository/Settings/Dashboard/header/button_Add'))
		WebUI.waitForElementVisible(findTestObject('Object Repository/Settings/Costs Items Settings/input_Code_designation'), 0)
		WebUI.setText(findTestObject('Object Repository/Settings/Costs Items Settings/input_Code_designation'), '1')
		WebUI.setText(findTestObject('Object Repository/Settings/Costs Items Settings/input_Label'), 'test')
		WebUI.click(findTestObject('Object Repository/Settings/Costs Items Settings/input_Cost Category'))
		WebUI.sendKeys(findTestObject('Object Repository/Settings/Costs Items Settings/input_Cost Category'),Keys.chord(Keys.ENTER))
		...
		WebUI.waitForElementVisible(findTestObject('Object Repository/Settings/Costs Items Settings/input_Code Dashboard'),0)
		WebUI.setText(findTestObject('Object Repository/Settings/Costs Items Settings/input_Code Dashboard'),'1')
		WebUI.delay(3)
	...
	def editCostItem() {
		...
		WebUI.waitForElementVisible(findTestObject('Object Repository/Settings/Costs Items Settings/input_Code_designation'), 0)
		WebUI.setText(findTestObject('Object Repository/Settings/Costs Items Settings/input_Code_designation'), '2')
		WebUI.setText(findTestObject('Object Repository/Settings/Costs Items Settings/input_Label'), 'test2')
		WebUI.uncheck(findTestObject('Object Repository/Settings/Settings Commons/checkbox_Means Of Transport (AIR)'))
		WebUI.check(findTestObject('Object Repository/Settings/Settings Commons/checkbox_Means Of Transport (SEA)'))
		WebUI.check(findTestObject('Object Repository/Settings/Settings Commons/checkbox_Means Of Transport (ROAD)'))
		WebUI.check(findTestObject('Object Repository/Settings/Settings Commons/checkbox_Means Of Transport (INTEGRATOR)'))
		WebUI.check(findTestObject('Object Repository/Settings/Settings Commons/checkbox_Means Of Transport (RAIL)'))
		WebUI.check(findTestObject('Object Repository/Settings/Settings Commons/checkbox_Means Of Transport (WATERWAY)'))
		...
		WebUI.verifyElementVisible(findTestObject('Object Repository/Growl Notification/flash_Notice_Operation successfully completed'),FailureHandling.CONTINUE_ON_FAILURE)
		WebUI.waitForElementVisible(findTestObject('Object Repository/Settings/Costs Items Settings/input_Code Dashboard'),0)
		WebUI.setText(findTestObject('Object Repository/Settings/Costs Items Settings/input_Code Dashboard'),'2')
		WebUI.delay(3)
		WebUI.verifyElementVisible(findTestObject('Object Repository/Settings/Dashboard/first checkbox of the list'))
	}
